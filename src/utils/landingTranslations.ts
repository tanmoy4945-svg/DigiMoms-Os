...
export const landingTranslations: Record<Language, LandingTranslation> = {
  en: {
    ...
    agencyService2Desc: 'Custom online store setups with Razorpay payment gateways, inventory tracking, and client billing.',
    ...
    osStep4Desc: 'Waiters deliver orders, guests pay via Cash or UPI (PhonePe, GPay, Paytm), and receive digital PDF invoices.',
  ...
  bn: {
    ...
    agencyService2Desc: 'Razorpay পেমেন্ট গেটওয়ে, ইনভেন্টরি ট্র্যাকিং এবং ক্লায়েন্ট বিলিং সহ অনলাইন স্টোর সেটআপ।',
    ...
    osStep4Desc: 'ওয়েটার খাবার পরিবেশন করেন, ক্যাশ বা ইউপিআই (PhonePe, GPay, Paytm) দিয়ে পেমেন্ট হয় এবং ডিজিটাল পিডিএফ বিল পান।',
  ...
  hi: {
    ...
    agencyService2Desc: 'Razorpay पेमेंट गेटवे, इन्वेंट्री ट्रैकिंग और ऑटोमेटेड क्लाइंट बिलिंग के साथ ऑनलाइन स्टोर्स।',
    ...
    osStep4Desc: 'वेटर भोजन परोसते हैं, नकद या यूपीआई (PhonePe, GPay, Paytm) से भुगतान होता है और ग्राहक को डिजिटल PDF बिल मिलता है।',
