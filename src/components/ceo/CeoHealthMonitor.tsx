...
import { Database, HardDrive, AlertTriangle, CheckCircle2, Info } from 'lucide-react';
...
export function CeoHealthMonitor() {
  ...
  const metrics = useMemo(() => {
    ...
    return { totalMb, percentage, status, estimatedStorageMb, storagePercentage, storageStatus, totalRows };
  }, [
